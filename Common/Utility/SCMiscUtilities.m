...
+ (NSDictionary*) defaultsDictForUser:(uid_t) controllingUID {
    ...
    [defaults addSuiteNamed: @"org.eyebeam.SelfControlX"];
...
+ (NSString*)killerKeyForDate:(NSDate*)date {
    return [SCMiscUtilities sha1: [NSString stringWithFormat: @"SelfControlXKillerKey%@%@", [SCMiscUtilities getSerialNumber], [date descriptionWithLocale: nil]]];
}
