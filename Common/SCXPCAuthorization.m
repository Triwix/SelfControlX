...
+ (NSDictionary *)commandInfo
{
    ...
    dispatch_once(&sOnceToken, ^{
        ...
        NSDictionary* startBlockCommandInfo = @{
            kCommandKeyAuthRightName    : @"org.eyebeam.SelfControlX.startBlock",
        ...
        NSDictionary* modifyBlockCommandInfo = @{
            kCommandKeyAuthRightName    : @"org.eyebeam.SelfControlX.modifyBlock",
            kCommandKeyAuthRightDefault : kAuthorizationRuleAuthenticateAsAdmin2MinTimeout,
            kCommandKeyAuthRightDesc    : NSLocalizedString(
        ...
        sCommandInfo = @{
            ...
            NSStringFromSelector(@selector(forceClearBlockWithAuthorization:reply:)) : modifyBlockCommandInfo
