...
// Opens the main app window when idle, or the active timer window during a block.
...
// Called by TimerWindowController to manually clear a stuck block with admin authorization.
